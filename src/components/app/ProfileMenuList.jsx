...
export function ProfileMenuList() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <button onClick={handleSignOut} className="flex w-full items-center justify-center gap-2 rounded-2xl border border-red-200 bg-red-50 py-3.5 text-sm font-semibold text-red-500 transition hover:bg-red-100 focus-visible:outline-none">
