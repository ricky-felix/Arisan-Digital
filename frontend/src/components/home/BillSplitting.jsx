...
const splitCards = [
  {
    ...
    description:
      "Masukkan total tagihan sekali, dan WebApp langsung menghitung bagian setiap orang. Bisa dibagi rata atau sesuai porsi masing-masing.",
  },
  {
    icon: BiGroup,
      ...
      <Reveal className="container mx-auto">
        <div className="mb-12 grid grid-cols-1 items-start gap-x-12 gap-y-8 md:mb-16 md:grid-cols-2 lg:mb-20 lg:gap-x-20">
          <div className="reveal-left">
            ...
            >
              Sekarang bisa bagi tagihan / patungan
            </h2>
          </div>
